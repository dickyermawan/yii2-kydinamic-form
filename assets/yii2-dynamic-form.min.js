 ...
 * @Date: 2020-04-27 10:32:39 
 * @Last Modified by: Dicky Ermawan S., S.T., MTA
 * @Last Modified time: 2021-10-02 21:42:24
 */
    ...
    var _restoreSpecialJs = function (widgetOptions) {
        ...
        if ($hasNumberControl.length > 0) {
            ...
            $hasNumberControl.each(function () {
                ...
                var displayID = id + '-disp';
                $(displayID).removeData('inputmask');
                $(displayID).on('change', function (e) {
                    $(that).val($(displayID).inputmask('unmaskedvalue'));
                    // $(that).val($(displayID).val());
                    // console.log($(displayID).inputmask('unmaskedvalue'));
                });
                $(displayID).inputmask(configNumberControl.maskedInputOptions);
